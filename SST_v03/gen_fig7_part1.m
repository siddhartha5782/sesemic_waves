%
% run SST on varicella. save the result for display
%
clear; close all;
...
load Varicella.20120127.1mCohort.txt
x = 1000*Varicella_20120127_1mCohort(:,4)./Varicella_20120127_1mCohort(:,2);
...
save varicella_rslt stfd trendhat noisehat x1hat freq t x
