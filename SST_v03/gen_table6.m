...
fprintf('================================================\n');
fprintf('\tGenerate Table 6 (talbe 2 plus outliers) \n\n');
...
eval(['save rslt/table6_X',num2str(kkk),'_T',num2str(jj0),'_',num2str(ss0),'_rslt stfd trend trendhat noise noisehat x1 x1hat x2 x2hat freq t xt']);

eval(['save rslt/table6_X',num2str(kkk),'_T',num2str(jj0),'_',num2str(ss0),'_allsave save_s1hat save_s2hat save_That save_noisehat']);
