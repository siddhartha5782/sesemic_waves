...
QQQ1 <-readMat("/Users/hauwu/Dropbox/tex20120723/_WORKING_seasonality/fig/simuY3_rslt.mat")
#QQQ1 <-readMat("/Users/hau-tiengwu/Dropbox/tex20120723/_WORKING_seasonality/fig/simuY3_rslt.mat")

#par(mfrow = c(4,2), mar=c(0.1,2,1,0.8)+0.1, oma=c(2,1,1,1), cex=1.1)
par(mfrow = c(4,2));
